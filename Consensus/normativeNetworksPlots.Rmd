...
```{r}
LatinoConnectProb1[LatinoConnectProb1>.25] <- 1 
mat<-LatinoConnectProb1
mat[1:304,1:8] <- 0
subGraph<-graph.adjacency(mat)

V(subGraph)$Names <-  c(idNames, posTraits$trait, negTraits$trait)
V(subGraph)$Names[1] <- "Latino"
...
```{r}
AsianConnectProb1[AsianConnectProb1>.25] <- 1 
mat<-AsianConnectProb1
mat[1:304,1:8] <- 0
subGraph<-graph.adjacency(mat)

V(subGraph)$Names <-  c(idNames, posTraits$trait, negTraits$trait)
V(subGraph)$Names[1] <- "Asian"
V(subGraph)$group[1:8] <- c("ID")
V(subGraph)$group[9:156] <- c("Pos")
V(subGraph)$group[157:304] <- c("Neg")
...
```{r}
CatholicConnectProb1[CatholicConnectProb1>.25] <- 1 
mat<-CatholicConnectProb1
mat[1:304,1:8] <- 0
subGraph<-graph.adjacency(mat)

V(subGraph)$Names <-  c(idNames, posTraits$trait, negTraits$trait)
V(subGraph)$Names[4] <- "Catholic"
V(subGraph)$group[1:8] <- c("ID")
V(subGraph)$group[9:156] <- c("Pos")
V(subGraph)$group[157:304] <- c("Neg")

RaceNetNoTraits <- ego(subGraph, order = 1, nodes = 4, mode = "out",
  mindist = 0)
RaceNetNoTraits <- induced.subgraph(subGraph, vids = unlist(RaceNetNoTraits) )
