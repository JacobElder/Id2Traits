...
```{r}
rawFirst <- read.csv("~/Google Drive/Volumes/Research Project/Identities to Traits/Study 1/Cleaning/Input/rawFirst.csv", header = T)
rawFirst <- rawFirst[!as.numeric(duplicated(rawFirst$id)),]
rawSec <- read.csv("~/Google Drive/Volumes/Research Project/Identities to Traits/Study 1/Cleaning/Input/rawSecond.csv", header = T)
...
```{r}
# idSubs <- grep("Race_Ident",colnames(rawFirst)):grep("Hob_Ident",colnames(rawFirst))
# 
# rawFirst[idSubs]
# apply(rawFirst[idSubs], 2, function(x) gsub("\\{|\\}", "", x))
# 
# rawFirst[idSubs] <- apply(rawFirst[idSubs], 2, function(x) gsub("\\{|\\}", "", x))
# rawFirst[idSubs] <- apply(rawFirst[idSubs], 2, function(x) gsub("\\$|\\$", "", x))
# rawFirst[idSubs] <- apply(rawFirst[idSubs], 2, function(x) gsub("/ChoiceGroup/AllChoicesTextEntry", "", x ) )
# rawFirst[idSubs] <- apply(rawFirst[idSubs], 2, function(x) gsub("\\s*\\([^\\)]+\\)","", x) )
# 
# gsub(".*QID", "", rawFirst[grep("Race_Ident",colnames(rawFirst)):grep("Hob_Ident",colnames(rawFirst))])
# 
# 
# gsub("${q://", "", rawFirst$Race_Ident)
```
...
idSubs <- grep("Race_Ident",colnames(rawFirst)):grep("Hob_Ident",colnames(rawFirst))
emptyRows<-apply(rawFirst[idSubs], c(1,2), is.emptyString)
rawFirst<-rawFirst[!apply(emptyRows, 1, all),]
missRows <- rowSums(apply(rawSec, c(1,2), is.na))
badRows <- missRows > 30
...
```{r}
idSubs <- grep("Race_Ident",colnames(rawFirst)):grep("Hob_Ident",colnames(rawFirst))
rawFirst[idSubs] <- apply(rawFirst[idSubs], 2, function(x) gsub("8", "", x))
rawFirst[idSubs] <- apply(rawFirst[idSubs], 2, function(x) gsub("149", "", x))
rawFirst[idSubs] <- apply(rawFirst[idSubs], 2, function(x) gsub("150", "", x))
rawFirst[idSubs] <- apply(rawFirst[idSubs], 2, function(x) gsub(",,", ",", x))
#rawFirst[idSubs] <- apply(rawFirst[idSubs], 2, function(x) gsub(",", "", x))

# Race Replacements
rawFirst$Race_Ident <- gsub("1","Gen",rawFirst$Race_Ident)
rawFirst$Race_Ident <- gsub("2","Sex",rawFirst$Race_Ident)
rawFirst$Race_Ident <- gsub("3","Rel",rawFirst$Race_Ident)
rawFirst$Race_Ident <- gsub("4","SES",rawFirst$Race_Ident)
rawFirst$Race_Ident <- gsub("5","Occup",rawFirst$Race_Ident)
rawFirst$Race_Ident <- gsub("6","Pol",rawFirst$Race_Ident)
rawFirst$Race_Ident <- gsub("7","Hob",rawFirst$Race_Ident)

# Gender Replacements
rawFirst$Gender_Ident <- gsub("1","Rac",rawFirst$Gender_Ident)
rawFirst$Gender_Ident <- gsub("2","Sex",rawFirst$Gender_Ident)
rawFirst$Gender_Ident <- gsub("3","Rel",rawFirst$Gender_Ident)
rawFirst$Gender_Ident <- gsub("4","SES",rawFirst$Gender_Ident)
rawFirst$Gender_Ident <- gsub("5","Occup",rawFirst$Gender_Ident)
rawFirst$Gender_Ident <- gsub("6","Pol",rawFirst$Gender_Ident)
rawFirst$Gender_Ident <- gsub("7","Hob",rawFirst$Gender_Ident)

# Sex Replacements
rawFirst$Sex_Ident <- gsub("1","Rac",rawFirst$Sex_Ident)
rawFirst$Sex_Ident <- gsub("2","Sex",rawFirst$Sex_Ident)
rawFirst$Sex_Ident <- gsub("3","Rel",rawFirst$Sex_Ident)
rawFirst$Sex_Ident <- gsub("4","SES",rawFirst$Sex_Ident)
rawFirst$Sex_Ident <- gsub("5","Occup",rawFirst$Sex_Ident)
rawFirst$Sex_Ident <- gsub("6","Pol",rawFirst$Sex_Ident)
rawFirst$Sex_Ident <- gsub("7","Hob",rawFirst$Sex_Ident)

# Religion Replacements
rawFirst$Relig_Ident <- gsub("1","Gen",rawFirst$Relig_Ident)
rawFirst$Relig_Ident <- gsub("2","Rac",rawFirst$Relig_Ident)
rawFirst$Relig_Ident <- gsub("3","Sex",rawFirst$Relig_Ident)
rawFirst$Relig_Ident <- gsub("4","SES",rawFirst$Relig_Ident)
rawFirst$Relig_Ident <- gsub("5","Occup",rawFirst$Relig_Ident)
rawFirst$Relig_Ident <- gsub("6","Pol",rawFirst$Relig_Ident)
rawFirst$Relig_Ident <- gsub("7","Hob",rawFirst$Relig_Ident)

# SES Replacements
rawFirst$SES_Ident <- gsub("1","Gen",rawFirst$SES_Ident)
rawFirst$SES_Ident <- gsub("2","Rac",rawFirst$SES_Ident)
rawFirst$SES_Ident <- gsub("3","Sex",rawFirst$SES_Ident)
rawFirst$SES_Ident <- gsub("4","Rel",rawFirst$SES_Ident)
rawFirst$SES_Ident <- gsub("5","Occup",rawFirst$SES_Ident)
rawFirst$SES_Ident <- gsub("6","Pol",rawFirst$SES_Ident)
rawFirst$SES_Ident <- gsub("7","Hob",rawFirst$SES_Ident)

# Occup Replacements
rawFirst$Occup_Ident <- gsub("1","Gen",rawFirst$Occup_Ident)
rawFirst$Occup_Ident <- gsub("2","Rac",rawFirst$Occup_Ident)
rawFirst$Occup_Ident <- gsub("3","Sex",rawFirst$Occup_Ident)
rawFirst$Occup_Ident <- gsub("4","Rel",rawFirst$Occup_Ident)
rawFirst$Occup_Ident <- gsub("5","SES",rawFirst$Occup_Ident)
rawFirst$Occup_Ident <- gsub("6","Pol",rawFirst$Occup_Ident)
rawFirst$Occup_Ident <- gsub("7","Hob",rawFirst$Occup_Ident)

# Pol Replacements
rawFirst$Pol_Ident <- gsub("1","Gen",rawFirst$Pol_Ident)
rawFirst$Pol_Ident <- gsub("2","Rac",rawFirst$Pol_Ident)
rawFirst$Pol_Ident <- gsub("3","Sex",rawFirst$Pol_Ident)
rawFirst$Pol_Ident <- gsub("4","Rel",rawFirst$Pol_Ident)
rawFirst$Pol_Ident <- gsub("5","SES",rawFirst$Pol_Ident)
rawFirst$Pol_Ident <- gsub("6","Occup",rawFirst$Pol_Ident)
rawFirst$Pol_Ident <- gsub("7","Hob",rawFirst$Pol_Ident)

# Hob Replacements
rawFirst$Hob_Ident <- gsub("1","Gen",rawFirst$Hob_Ident)
rawFirst$Hob_Ident <- gsub("2","Rac",rawFirst$Hob_Ident)
rawFirst$Hob_Ident <- gsub("3","Sex",rawFirst$Hob_Ident)
rawFirst$Hob_Ident <- gsub("4","Rel",rawFirst$Hob_Ident)
rawFirst$Hob_Ident <- gsub("5","SES",rawFirst$Hob_Ident)
rawFirst$Hob_Ident <- gsub("6","Occup",rawFirst$Hob_Ident)
rawFirst$Hob_Ident <- gsub("7","Pol",rawFirst$Hob_Ident)
...
# rawFirst$Race_Ident <- gsub("^3$","Rel",rawFirst$Race_Ident)
# rawFirst$Race_Ident <- gsub("^4$","Ses",rawFirst$Race_Ident)
# rawFirst$Race_Ident <- gsub("^5$","Job",rawFirst$Race_Ident)
# rawFirst$Race_Ident <- gsub("^6$","Pol",rawFirst$Race_Ident)
# rawFirst$Race_Ident <- gsub("^7$","Hob",rawFirst$Race_Ident)
# 
# # Gender Replacements
...
# rawFirst$Gender_Ident <- gsub("^3$","Rel",rawFirst$Gender_Ident)
# rawFirst$Gender_Ident <- gsub("^4$","Ses",rawFirst$Gender_Ident)
# rawFirst$Gender_Ident <- gsub("^5$","Job",rawFirst$Gender_Ident)
# rawFirst$Gender_Ident <- gsub("^6$","Pol",rawFirst$Gender_Ident)
# rawFirst$Gender_Ident <- gsub("^7$","Hob",rawFirst$Gender_Ident)
# 
# # Religion Replacements
...
# rawFirst$Relig_Ident <- gsub("^3$","Sex",rawFirst$Relig_Ident)
# rawFirst$Relig_Ident <- gsub("^4$","Ses",rawFirst$Relig_Ident)
# rawFirst$Relig_Ident <- gsub("^5$","Job",rawFirst$Relig_Ident)
# rawFirst$Relig_Ident <- gsub("^6$","Pol",rawFirst$Relig_Ident)
# rawFirst$Relig_Ident <- gsub("^7$","Hob",rawFirst$Relig_Ident)
# 
# # SES Replacements
...
# rawFirst$SES_Ident <- gsub("^3$","Sex",rawFirst$SES_Ident)
# rawFirst$SES_Ident <- gsub("^4$","Rel",rawFirst$SES_Ident)
# rawFirst$SES_Ident <- gsub("^5$","Job",rawFirst$SES_Ident)
# rawFirst$SES_Ident <- gsub("^6$","Pol",rawFirst$SES_Ident)
# rawFirst$SES_Ident <- gsub("^7$","Hob",rawFirst$SES_Ident)
# 
# # Job Replacements
...
# rawFirst$Pol_Ident <- gsub("^4$","Rel",rawFirst$Pol_Ident)
# rawFirst$Pol_Ident <- gsub("^5$","Ses",rawFirst$Pol_Ident)
# rawFirst$Pol_Ident <- gsub("^6$","Job",rawFirst$Pol_Ident)
# rawFirst$Pol_Ident <- gsub("^7$","Hob",rawFirst$Pol_Ident)
# 
# # Hob Replacements
# rawFirst$Hob_Ident <- gsub("^1$","Gen",rawFirst$Hob_Ident)
...
# rawFirst$Hob_Ident <- gsub("^4$","Rel",rawFirst$Hob_Ident)
# rawFirst$Hob_Ident <- gsub("^5$","Ses",rawFirst$Hob_Ident)
# rawFirst$Hob_Ident <- gsub("^6$","Job",rawFirst$Hob_Ident)
# rawFirst$Hob_Ident <- gsub("^7$","Pol",rawFirst$Hob_Ident)
```
...
for(i in uIds){
  ...
  subMat <- matrix(data = 0, nrow = 8, ncol = 8)
  for(c in 1:length(idSubs)){
    # subset identity "c"
    j <- idSubs[c]
    # split words by comma
    selectWord <-strsplit(as.character(subDf[,j][[1]]),",")
...
#     logprobs <- log2(probs)
#     logprobs[is.infinite(logprobs)] <- 0 # Setting log of 0 prob to 0 rather than infinite according to MacKay's book "Information Theory, Inference, and Learning Algorithms" (chapter 2)
#     output <- ( -sum(probs * logprobs) )
#     return(output)
# }
# 
# H.Score <- function(counts){
#   logcounts <- log2(counts)
#   logcounts[is.infinite(logcounts)] <- 0 # Setting log of 0 prob to 0 rather than infinite according to MacKay's book "Information Theory, Inference, and Learning Algorithms" (chapter 2)
#   output <- logcounts - sum(counts*logcounts) / length(counts)
#   return(output)
# }
# 
# permutedIdentities <- gtools::permutations(8, 2)
# combinedIdentities <- gtools::combinations(8, 2)
# 
# #traitCombinations <- list(gtools::combinations(8, 1),gtools::combinations(8, 2),gtools::combinations(8, 3),gtools::combinations(8, 4),gtools::combinations(8, 5),gtools::combinations(8, 6),gtools::combinations(8, 7),gtools::combinations(8, 8) ))
# 
# OL.Score <- function(pairs, matrix, type = "all"){
# 
#   summed <- 0
#   n <- 8 # number of identities
# 
#   if(type=="all"){
#    ind1 <- (8+1)
#    ind2 <- (8+296)
...
#    ind2 <- (8+148+148)
#   }
#   mat <- matrix[1:8,ind1:ind2]
#   #n <- sum(apply(mat[,1:148]==1, 2, function(x) any(x==T))) # number of traits nominated in choices
# 
#   for(i in 1:nrow(permutedIdentities) ){
# 
#     id1 <- permutedIdentities[i,1]
#     id2 <- permutedIdentities[i,2]
# 
#     vecId1 <- mat[id1,]
#     vecId2 <- mat[id2,]
# 
#     Cij = sum(vecId1 & vecId2 == 1)
#     Tj = sum(vecId2 == 1)
# 
#     curSum <- (Cij/Tj)
#     if(is.na(curSum)){
...
# }
# 
# OL.Score(permutedIdentities, subTonlyFMat, type = "all")
# OL.Score(permutedIdentities, subTonlyFMat, type = "pos")
# OL.Score(permutedIdentities, subTonlyFMat, type = "neg")
# 
# # H.Score <- function(pairs, matrix, type = "all"){
# # 
# #   counts <- matrix(nrow=nrow(pairs),ncol=1)
# # 
# #   if(type=="all"){
# #    ind1 <- (8+1)
# #    ind2 <- (8+296)
...
# #   #n <- sum(apply(mat[,1:148]==1, 2, function(x) any(x==T))) # number of traits nominated in choices
# # 
# #   for(i in 1:nrow(combinedIdentities) ){
# # 
# #     id1 <- combinedIdentities[i,1]
# #     id2 <- combinedIdentities[i,2]
# # 
# #     vecId1 <- mat[id1,]
# #     vecId2 <- mat[id2,]
# # 
# #     ni = sum(vecId1 & vecId2 == 1)
# # 
# #     logni <- log2(ni)
# #     logni[is.infinite(logni)] <- 0
# # 
# #     counts[i,] <- ni * logni
# # 
# #   }
# # 
# #   H <- log2(n) - (sum(counts[,1])/n)
# #   return(H)
# # 
# # }
# 
...
# }
# 
# H.Score(combinedIdentities, get(paste0("subTonlyFMat.",i)), type = "all")
# 
# data.frame(subID=uIds,
#            HScore =unlist(lapply(uIds, function(x) H.Score(combinedIdentities, get(paste0("subTonlyFMat.",x)), type = "all")))
# )
# HScores
# # H.Score(combinedIdentities, subTonlyFMat, type = "pos")
# # H.Score(combinedIdentities, subTonlyFMat, type = "neg")
```


```{r}
idSubs <- grep("Race_PosTraits",colnames(rawFirst)):grep("Hob_NegTraits",colnames(rawFirst))
# create empty matrices 148 trait causing 8 identities because traits don't cause identities
...
x3 <- c("subID","idEdgT", "density", "idAveDist", "idTrans", "idSW", "idStrengHom","idPosHom", "idUnifHom", "idMallHom", "idCommGlob", "traitCommGlob", "globEff")
...
for(i in uIds){
  #for(j in 1:length(idNames)){
    ...
    # of uniformity
    V(curGraph)$unif <- rawSec[rawSec$id==i, paste0("U_",c("Race","Gender","Sex","Relig","SES","Occup","Hob","Pol"))]
    idUnifHom <- assortativityNA(curGraph, as.numeric(V(curGraph)$unif)+rnorm(1, 0, .00001), directed=F)
    # of malleability
    V(curGraph)$mall <- rawSec[rawSec$id==i, paste0("M_",c("Race","Gender","Sex","Relig","SES","Occup","Hob","Pol"))]
    idMallHom <- assortativityNA(curGraph, as.numeric(V(curGraph)$mall)+rnorm(1, 0, .00001), directed=F)
    ...
    # # identity-to-identity entropy
    # curMat <- get(paste0("subIMat.",i))
    # ididEnt <- entropy(colMeans(curMat))
    ...
    # # identity-to-identity entropy
    # curMat <- get(paste0("subItoTonlyFMat.",i))
    # ididEnt <- entropy(colMeans(curMat))
    ...
    globalIDDf <- rbind(globalIDDf, data.frame(subID = i, idEdgT = idEdgT, idDensity = density, idTrans = idTrans, idSW = idSW, idStrengHom = idStrengHom, idPosHom = idPosHom, idUnifHom = idUnifHom, idMallHom = idMallHom, idCommGlob = idCommGlob, traitCommGlob = traitCommGlob,globEff = globEff))
...
```{r}
idSubs <- grep("I_Race",colnames(rawSec)):grep("U_Pol",colnames(rawSec))
...
```{r}
#idToSim<-merge(idToSim, idShort, by = c("subID","id"))
# mergeLong <- fullLong %>% select(-selfResp, -valence, -traits)
# idToSim <- merge(idToSim, fullLong, all.x = T)
#idToSim<-merge(idToSim, fullLong, by = c("subID","id"))
```


```{r}
rf <- read.csv("~/Google Drive/Volumes/Research Project/Identities to Traits/Study 1/Cleaning/Input/rawFirst.csv", header = T)
rf <- rf[!as.numeric(duplicated(rf$id)),]

idLabels <- read.csv("~/Google Drive/Volumes/Research Project/Identities to Traits/Study 1/Cleaning/Input/rawFirstQ.csv", header = T)
...
```{r}
combCodes <- read.csv("/Volumes/GoogleDrive/My Drive/Volumes/Research Project/Identities to Traits/Study 1/Cleaning/Input/IdCodes/combinedCodes.csv")
colnames(combCodes)[1:2] <- c("id","idCF")
combCodes$id <- stringr::str_to_title(combCodes$id)
combCodes$id <- gsub("Ses","SES",combCodes$id)
MatchDf <- merge(MatchDf, combCodes[c("id","idCF","minAve","margAve","minRel","margRel")], by = c("id","idCF"), all.x = T )
```

```{r}
# fullLong <- merge(fullLong, MatchDf, by = c("id","idC"), all.x = T)
# orderDf <- merge(orderDf, MatchDf, by = c("id","idC"), all.x = T)
# idToSim

qcidlong <- merge(qcidlong, MatchDf[c("idC","id","minAve","margAve")], by = c("idC","id"), all.x=T)
```
...
```{r}
indDiff <- rawSec[c(grep("^RSE1$",colnames(rawSec)):grep("^DS_17$",colnames(rawSec)), grep("^id$",colnames(rawSec)) )]
indDiff$check4 <- NULL
```
...
fullLong <- merge(fullLong, indDiff[c("subID","SE","SCC","NFC","Ind","Inter","SWLS","DS","MemSE","PrivCSE","PubCSE","IdImp","CESD")], by = "subID", all.x=T)
...
```{r}
indDiffSmall <- merge(indDiff[c("subID","SE","SCC","NFC","Ind","Inter","SWLS","DS","MemSE","PrivCSE","PubCSE","IdImp","CESD", "H_index", "overlap_norm", "phi")], globalIDDf, by = "subID")
```
...
for(i in uIds){
    ...
    # distance of uniformity
    unifVect <- as.vector(dist(idShort$unif[idShort$subID==i]))
    if(length(unifVect)<28){
      break
    }
    # distance of identification
    mallVect <- as.vector(dist(idShort$mall[idShort$subID==i]))
    if(length(mallVect)<28){
      break
    }
    

    
    curSimDf <- cbind(subID = rep(i,length(simVect)), pair = 1:28, idSim = simVect, idtSim = simVectIT, idtpSim = simVectIT.p, idtnSim = simVectIT.n, posDist = posVect, strengDist = strengVect, unifDist = c, mallDist = mallVect)
...
traits$Idx <- 1:296
veryLong <- merge(veryLong, traits, by = "traits")
...
# Similar Identities Predicting Similar Evaluations

Taking too long to generate and is an absolutely colossal dataframe so may abandon

```{r}
# combinedIdentities <- gtools::combinations(8, 2)
# x<-c("subID","id1","id2","dist","IIDist","IISim","Shared","valence")
# fullMat <- matrix(nrow=0,ncol=length(x))
# for(i in unique(veryLong$subID)){
#     curFGraph <- get(paste0("subTFGraph.",i))
#     curIGraph <- get(paste0("subIGraph.",i))
#   for(n in 1:nrow(combinedIdentities)){
#     j<-combinedIdentities[n,1]
#     d<-combinedIdentities[n,2]
#     
#     curIdDf <- veryLong[veryLong$subID==i & veryLong$id==idNames[j],]
#     curIdDf <- curIdDf %>% select(subID,traits,id,selfResp,connect,valence) %>% rename(selfRespFROM = selfResp, connectFROM = connect, valenceFROM=valence)
#     curIdDf$a <- 1:296
#     compareIdDf <- veryLong[veryLong$subID==i & veryLong$id==idNames[d],]
#     compareIdDf <- compareIdDf %>% select(subID,traits,id,selfResp,connect,valence) %>% rename(selfRespTO = selfResp, connectTO = connect,valenceTO=valence)
#     compareIdDf$b <- 1:296
#     
#      curDist <- distances(curIGraph)[j,d]
#      curSim <- similarity.dice(curIGraph)[j,d]
#     
#     combs <- crossing(a=1:296,b=1:296) %>% left_join(curIdDf, by = "a") %>% left_join(compareIdDf, by = "b")
# 
#     # Calculate the distances
#     pairs<- combs %>% 
#       mutate(dist = abs(selfRespFROM - selfRespTO), shared = connectFROM+connectTO, valence = paste0(valenceFROM,valenceTO))
#     pairs$valence <- ifelse(pairs$valence %in% c("positivenegaitve","negativepositive"), "positivenegative", pairs$valence)
#     pairs <- pairs[pairs$a!=pairs$b,]
# 
#     if(nrow(pairs)==0){
#       next
#     }else{
#     curMat <- cbind(subID = i, id1=idNames[d], id2=idNames[j], dist=pairs$dist, IIDist=curDist, IISim=curSim, shared=pairs$shared, valence = pairs$valence)
...
# x<-c("subID","id1","id2","dist","IIDist","IISim","Shared","valence")
# fullMat <- matrix(nrow=0,ncol=length(x))
# usubs <- unique(veryLong$subID)
# 
#   core<-detectCores()
#   cl <- parallel::makeCluster(core-2, setup_strategy = "sequential")
#   setDefaultCluster(cl=cl)
#   registerDoParallel(cl)
#   clusterExport(cl, list("x","fullMat","combinedIdentities","usubs","veryLong","idNames"))
# 
# for(s in 1:length(usubs) ){
#   
#   i <- usubs[s]
#   
#     curFGraph <- get(paste0("subTFGraph.",i))
#     curIGraph <- get(paste0("subIGraph.",i))
#     
#     clusterExport(cl, list("curFGraph","curIGraph"))
#     
#   result<-foreach(s=1:nrow(combinedIdentities), .combine = rbind, .packages = c("igraph","tidyverse")) %dopar% {
#     j<-combinedIdentities[n,1]
#     d<-combinedIdentities[n,2]
#     
#     curIdDf <- veryLong[veryLong$subID==i & veryLong$id==idNames[j],]
...
#       next
#     }else{
#     result <- cbind(i, idNames[d], idNames[j], pairs$dist, curDist, curSim, pairs$shared, pairs$valence)
#     }
# 
#   }
#   
#   fullMat <- rbind(fullMat, result)
# }
# dim(fullMat)
# 
# view(result)
...
```{r}
#write.csv(fullLong, "~/Google Drive/Volumes/Research Project/Identities to Traits/Study 1/Cleaning/Output/id2traitDf.csv", row.names = F)
write.csv(demos, "~/Google Drive/Volumes/Research Project/Identities to Traits/Study 1/Cleaning/Output/demos.csv", row.names = F)
# this literally won't write because it's so long
#write.csv(veryLong, "~/Google Drive/Volumes/Research Project/Identities to Traits/Study 1/Cleaning/Output/id2traitDf.csv", row.names = F)
# same
#write.csv(orderDf, "~/Google Drive/Volumes/Research Project/Identities to Traits/Study 1/Cleaning/Output/orderDf.csv", row.names = F)
write.csv(idShort, "~/Google Drive/Volumes/Research Project/Identities to Traits/Study 1/Cleaning/Output/id2traitShort.csv", row.names = F)
write.csv(indDiffSmall, "~/Google Drive/Volumes/Research Project/Identities to Traits/Study 1/Cleaning/Output/indDiff.csv", row.names = F)
write.csv(fullSimDf, "~/Google Drive/Volumes/Research Project/Identities to Traits/Study 1/Cleaning/Output/identitySimDf.csv", row.names = F)
write.csv(wideId, "~/Google Drive/Volumes/Research Project/Identities to Traits/Study 1/Cleaning/Output/idWide.csv", row.names = F)
save.image("~/Google Drive/Volumes/Research Project/Identities to Traits/Study 1/Cleaning/Output/id2traitsworkspace.RData")
```

```{r}
arrow::write_parquet(demos, here("Study 1/cleaned/demos.parquet"))
arrow::write_parquet(veryLong, here("Study 1/cleaned/id2traitDf.parquet"))
arrow::write_parquet(orderDf, here("Study 1/cleaned/orderDf.parquet"))
arrow::write_parquet(idShort, here("Study 1/cleaned/id2traitShort.parquet"))
arrow::write_parquet(indDiffSmall, here("Study 1/cleaned/indDiff.parquet"))
arrow::write_parquet(fullSimDf, here("Study 1/cleaned/identitySimDf.parquet"))
arrow::write_parquet(wideId, here("Study 1/cleaned/idWide.parquet"))
```
