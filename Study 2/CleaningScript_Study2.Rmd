...
```{r}
rawFirst <- read.csv("~/Google Drive/Volumes/Research Project/Identities to Traits/Study 2/Cleaning/Input/rawFirst.csv", header = T)
rawFirst <- rawFirst[!as.numeric(duplicated(rawFirst$id)),]
rawSec <- read.csv("~/Google Drive/Volumes/Research Project/Identities to Traits/Study 2/Cleaning/Input/rawSecond.csv", header = T)
...
```{r}
dir.create(here("Study 2/cleaned"))
arrow::write_parquet(demos, here("Study 2/cleaned/demos.parquet"))
arrow::write_parquet(veryLong, here("Study 2/cleaned/id2traitDf.parquet"))
arrow::write_parquet(orderDf, here("Study 2/cleaned/orderDf.parquet"))
arrow::write_parquet(idShort, here("Study 2/cleaned/id2traitShort.parquet"))
arrow::write_parquet(indDiffSmall, here("Study 2/cleaned/indDiff.parquet"))
arrow::write_parquet(fullSimDf, here("Study 2/cleaned/identitySimDf.parquet"))
arrow::write_parquet(wideId, here("Study 2/cleaned/idWide.parquet"))
```
